...
> 2025년 2학기 AID 동아리의 **혼자 공부하는 머신러닝+딥러닝** 스터디 저장소입니다. 주차별 자료, 발표 링크, 과제를 관리합니다.

## 소개

AID 동아리에서 진행하는 **머신러닝·딥러닝 기초 스터디**입니다. 교재의 이론과 실습을 요약하고, 정리한 내용들을 발표자가 주마다 발표하며, 정리하며 어려웠던 내용을 서로 공유하여 이해를 돕습니다.

## 운영 규칙

* **대면 스터디:** 매주 **목요일** 진행
* **과제 업로드:** 매주 **수요일 24:00까지** .ipynb / velog 형식으로 깃헙에 업로드
* **발표:** 매주 돌아가며 가볍게 발표 및 질의응답
* **요약 업로드:** 각자 정리한 파일을 **velog**를 통해 작성 후 깃헙에 업로드


## 진행 일정

>> 2주에 한번씩 AID 레포로 PR 요청(스터디 인증)
...
* 조승현 (스터디장)
* [칫수뛔이](https://github.com/CharleyThway)
* [신수민](https://github.com/rambutan1010)
...
* README의 **진행 일정 표**와 주차별 README.md`는 매주 스터디장이 업데이트.
* 팀원들의 개인 사정이 생겨 스터디 진행을 못할 경우 비대면 진행 
